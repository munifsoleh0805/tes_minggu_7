...
<div class="container">
  ...
  <div class="form-group">
    ...
    <input type="text" name="nama" value="<?php echo $data_siswa[0]["nama_siswa"]; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="motivasi" value="<?php echo $data_siswa[0]["motivasi"]; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Tim</label>
    <input type="text" name="tim" value="<?php echo $data_siswa[0]["nama_tim"]; ?>" class="form-control" id="exampleInputPassword1">
  </div>
